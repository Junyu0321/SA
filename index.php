        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/blue.png" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                    <h1 class="display-2 mb-5 animated slideInDown">輔大活動管理系統</h1>
                                    <a href="login/login.php" class="btn btn-dark rounded-pill py-sm-3 px-sm-5">登入</a>
                                    <a href="hello/register.html" class="btn btn-dark rounded-pill py-sm-3 px-sm-5 ms-3">申請校外人士帳號</a>
                                </div>
                            </div>
                        </div>
                    </div>
